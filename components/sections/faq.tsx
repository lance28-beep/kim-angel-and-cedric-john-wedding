...
const faqItems: FAQItem[] = [
  {
    ...
    answer:
      `Our wedding will be held on ${siteContent.wedding.date}. The wedding ceremony will start at exactly 4:00 PM. We kindly ask guests to arrive by 3:30 PM to help us begin promptly.`,
  },
  {
